...
This script sets up a connection to AWS based on credentials and store the annotation json file in a specified location.
...
- ROLE_ARN: role ARN
- BUCKET_NAME: S3 bukcet name
- AWS_ACCESS_KEY_ID: The access key for your AWS account. With this key, the client will be automatically initialized.
- AWS_SECRET_ACCESS_KEY: The secret key for your AWS account.With this key, the client will be automatically initialized.

describe how to create secrets and how mount to the action in the pipline canvas page
and there will be lined as env vars
